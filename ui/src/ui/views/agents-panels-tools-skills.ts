    ...
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">
            ...
            <span class="mono">${enabledCount}/${toolIds.length}</span> ${t("agents.enabled")}.
          </div>
        </div>
      ...
      ${
        params.toolsCatalogLoading
          ? html`
              <div class="card-sub" style="margin-top: 10px">${t("agents.refreshingCatalog")}</div>
            `
          : nothing
      }
    </section>
...
export function renderAgentSkills(params: {
  ...
  return html`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          <div class="card-title">${t("agents.skills")}</div>
          <div class="card-sub">
            ${t("agents.skillsSub")}
            ${
              totalCount > 0
