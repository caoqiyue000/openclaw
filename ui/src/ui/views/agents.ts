    ...
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>${skillFilter ? t("agents.selected", { count: String(skillCount) }) : t("agents.allSkills")}</div>
        </div>
      </div>
            ...
            >
              ${
                isDefault
                  ...
                  : html`
                      <option value="">
                        ${defaultPrimary ? t("agents.inheritDefaultWith", { model: defaultPrimary }) : t("agents.inheritDefault")}
                      </option>
                    `
              }
